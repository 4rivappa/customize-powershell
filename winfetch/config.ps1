...
# visit https://github.com/kiedtl/winfetch/ and observe winfetch.ps file 
# change accordingly to C:\Users\ARIVAPPA\scoop\apps\winfetch\<Version>\ winfetch.ps file
...
#function info_custom_title {
    ...
    #}
#}
function info_custom_keyboard_layout {
    return @{
        title = "Keyboard"
        content = "Dvorak"
    }
